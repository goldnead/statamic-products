...
return [
    ...
    'type_access' => 'Zugang',
    'type_access_description' => 'Kurs, Mitgliederbereich, Community.',
    'type_event' => 'Termin',
    'type_event_description' => 'Live-Event, Workshop, Konzert, Webinar.',
    'type_sessions' => 'Sitzungen',
    'type_sessions_description' => 'Ein Paket aus mehreren Terminen, 1:1 oder in der Gruppe.',
    'type_cohort' => 'Kohorte',
    'type_cohort_description' => 'Programm mit Start, Ende und fester Gruppe.',
    'type_feed' => 'Feed',
    'type_feed_description' => 'Bezahlter Podcast oder Newsletter.',

    'ref_download' => 'Kein Ziel',
    'ref_access' => 'Statamic-Eintrag (ID)',
    'ref_event' => 'Termin aus statamic-events (UUID)',
    'ref_sessions' => 'Buchungsstrecke aus statamic-booking (Kennung)',
    'ref_cohort' => 'Statamic-Eintrag (ID)',
